...
public class UpdatePIN extends javax.swing.JFrame {
    ...
    private Connect thebus;

    /**
     * Creates new form updatePIN
     */
    public UpdatePIN() {
        this.thebus = MainForm.connect;
        initComponents();
    }
    ...
    private void btn_changePINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_changePINActionPerformed
        ...
        if (dataRes[0] == (byte) 0x00) {
            ...
            if (newPIN.equals(pin) == true) {
                JOptionPane.showMessageDialog(this, "Mã PIN mới phải khác mã PIN cũ");
            ...
            JOptionPane.showMessageDialog(null, "Mã PIN sai. Vui lòng nhập lại! Bạn còn 1 lần thử.");
        } else if (dataRes[0] == (byte) 0x02) {
            JOptionPane.showMessageDialog(null, "Mã PIN sai. Vui lòng nhập lại! Bạn còn 2 lần thử.");
        } else if (dataRes[0] == (byte) 0x03) {
            JOptionPane.showMessageDialog(null, "Mã PIN sai. Vui lòng nhập lại! Bạn còn 3 lần thử.");
        } else {
            JOptionPane.showMessageDialog(this, "Bạn đã nhập sai quá số lần cho phép. Thẻ đã bị khóa!");
        }
